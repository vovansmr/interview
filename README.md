...
See the [open issues](https://github.com/vovansmr/interview/issues) for a full list of proposed features (and known issues).
...
[license-url]: https://github.com/vovansmr/interview/blob/master/LICENSE.txt
